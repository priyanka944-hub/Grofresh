  ...
  return (
    ...
    <div className='all'>
      <div className='head-container'>
           ...
           <div>All Orders</div>
           <div><h6><Badge bg="light" text='dark'>36</Badge></h6></div>
...
<img src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/pending.png" alt="dashboard" className="oder--card-icon"/>
<span>Pending</span>
</h6>
<span className="card-title text-0661CB">
12
</span>
</div>
</a>
...
<div className="d-flex justify-content-between align-items-center">
<h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
<img src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/confirmed.png" alt="dashboard" className="oder--card-icon"/>
<span>Confirmed</span>
</h6>
<span className="card-title text-107980">
6
</span>
</div>
</a>
...
<div className="d-flex justify-content-between align-items-center">
<h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
<img src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/processing.png" alt="dashboard" className="oder--card-icon"/>
<span>Packaging</span>
</h6>
...
<div className="d-flex justify-content-between align-items-center">
<h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
<img src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/out-for-delivery.png" alt="dashboard" className="oder--card-icon"/>
<span>Out for delivery</span>
</h6>
<span className="card-title text-00B2BE">
0
</span>
</div>
</a>
