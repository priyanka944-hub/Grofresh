      ...
      <div className="all">
        ...
        <div className="card-cover-one">
          <div className="card-cover">
            ...
            <div className="p-20px pb-0 mt-4">
              <div className="row g-3 g-sm-4 g-md-3 g-lg-4">
                <div className="col-sm-6 col-lg-3">
                  <a className="order--card h-100" href="#">
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/pending.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
                        <span>Pending</span>
                      </h6>
                      <span className="card-title text-0661CB">12</span>
                    </div>
                  </a>
                </div>
                <div className="col-sm-6 col-lg-3">
                  <a className="order--card h-100" href="#">
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/confirmed.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
                        <span>Confirmed</span>
                ...
                <div className="col-sm-6 col-lg-3">
                  <a className="order--card h-100" href="#">
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/processing.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
                        <span>Packaging</span>
                ...
                <div className="col-sm-6 col-lg-3">
                  <a className="order--card h-100" href="#">
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/out-for-delivery.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
                        <span>Out for delivery</span>
                      </h6>
                      <span className="card-title text-00B2BE">0</span>
                    </div>
                  </a>
                </div>
                <div className="col-sm-6 col-lg-3">
                  <a className="order--card h-100" href="#">
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/1.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
                        <span>Delivered</span>
                      </h6>
                      <span className="card-title text-success">10</span>
                    </div>
                  </a>
                </div>
                ...
                <div className="col-sm-6 col-lg-3">
                  <a className="order--card h-100" href="#">
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/2.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
                        <span>Canceled</span>
                      </h6>
                      <span className="card-title text-danger">3</span>
                    </div>
                  </a>
                </div>
                ...
                <div className="col-sm-6 col-lg-3">
                  <a
                    ...
                    href="https://grofresh-admin.6amtech.com/admin/orders/list/returned"
                  >
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/3.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
                        <span>Returned</span>
                      </h6>
                      <span className="card-title text-warning">1</span>
                    </div>
                  </a>
                </div>
                <div className="col-sm-6 col-lg-3">
                  <a className="order--card h-100" href="#">
                    <div className="d-flex justify-content-between align-items-center">
                      <h6 className="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img
                          src="https://grofresh-admin.6amtech.com/public/assets/admin/img/delivery/4.png"
                          alt="dashboard"
                          className="oder--card-icon"
                        />
              ...
              <div className="order-top">
                <div className="card--header">
                  <form
                    action=""
                    method="GET"
                    className="col-12 col-sm-12 col-md-6 col-lg-6 search_form"
                  >
                  ...
                  <div className="hs-unfold mr-2">
                    ...
                    <div
                      ...
                      className="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-sm-right hs-unfold-hidden hs-unfold-content-initialized hs-unfold-css-animation animated"
                      data-hs-target-height="98.7125"
                    ...
                    >
                      ...
                      <a
                        ...
                        href="https://grofresh-admin.6amtech.com/admin/orders/export/all"
                      >
                        <img
                  ...
                  <tbody id="set-rows">
                    <tr className="status-pending className-all">
                      ...
                      <td className="table-column-pl-0">
                        <a href="https://grofresh-admin.6amtech.com/admin/orders/details/100042">
                          100042
                        </a>
                      </td>
                      <td>27 Mar 2023</td>
                      ...
                      <td>
                        <div>
                          <a
                            ...
                            href="https://grofresh-admin.6amtech.com/admin/customer/view/15"
                          >
                            New Test User
                          </a>
                        </div>
