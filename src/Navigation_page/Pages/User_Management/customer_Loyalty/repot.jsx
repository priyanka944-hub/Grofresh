...
import './customerloyalityreport.css';
    ...
    <>
     <div className='container'> 
           <div className='heading icon'>
                <div>
                <img src="https://grofresh-admin.6amtech.com/public/assets/admin/img/point.png"  width={"40px"} alt="public"></img>
                </div>&nbsp;&nbsp;&nbsp;
                <span><h4><b>Customer Loyalty Point Report</b></h4></span>
           </div><br></br>
           <div className='card'>
                ...
                <div className='col-12 col-sm-4 col-md-4 col-lg-4 '>
                    <div className='card whole'>
                        <div className='image'>
                         ...
                         <h5 className='debit'>674.00</h5><br></br>
                    </div>
                 </div>
                <div className='col-12 col-sm-4 col-md-4 col-lg-4'>
                    <div className='card whole1'>
                        ...
                        <img class="resturant-icon" src="https://grofresh-admin.6amtech.com/public/assets/admin/img/dashboard/4.png"  alt="dashboard"></img>
                         ...
                         <h5 className='debit'>1,156.00</h5><br></br>
                    </div>
                </div>
                 <div className='col-12 col-sm-4 col-md-4 col-lg-4'>
                    <div className='card whole3'>
                        ...
                        <img class="resturant-icon" src="https://grofresh-admin.6amtech.com/public/assets/admin/img/dashboard/1.png" alt="dashboard"></img>
                         ...
                         <h5 className='debit'>482.00</h5><br></br>
                    </div>
                </div>
            </div><br></br>
            <div className='card'>
                    ...
                    <table className='table table-stripped'>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>300</td>
                          <td>200</td>
                          <td><button className='text-dark back Loyality'>Loyalty point to wallet</button></td>
                          <td>2023/03/25</td>
                        </tr>
                      </tbody>
                    </table>
