          ...
          <div className="table-responsive datatable-custom">
            <table className="table table-borderless  card-table">
              ...
              <tr>
                ...
                <td>
                  <span>
                    <img src={img1} className="img" alt="logo" />
                  </span>
              ...
              <tr>
                ...
                <td>
                  <span>
                    <img src={img2} className="img" alt="logo" />
                  </span>
                  <span> Green Grapes</span>
                </td>
                <td>
                  ...
                  <div>
                    The products and pricing was good. <br />
                    Received the products well in time.
                  </div>
                </td>
                <td>
                  <div>
                    <b>
                      <a href="">Fatema Subarna </a>
                    </b>
                  </div>
                  <div>
                    <a href="">+8801885576622</a>
                  </div>
                </td>
                <td>
                  {" "}
              ...
              <tr>
                ...
                <td>
                  <span>
                    <img src={img3} className="img" alt="logo" />
                  </span>
                  <span>Oranges</span>
                </td>
                <td>
