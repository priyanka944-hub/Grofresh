...
import Earning from "./Navigation_page/Pages/Report_Analytics/earning_report";
import Expenses from "./Navigation_page/Pages/Report_Analytics/expense_report";
function App() {
      ...
      <Router>
        ...
        <div className={`main-container ${inactive ? "inactive" : " "}`}>
          <Routes>
            ...
            <Route path={"/Oders-out-for-delivery"} element={<OutforDelivery />}/>
            ...
            <Route path={"/earning-report"} element={<Earning />} />
            <Route path={"/expense-report"} element={<Expenses />} />
            ...
            <Route path="/delivery-man-delivery-man-reviews"element={<DeliveryManReviews />}/>
            <Route path="/deliveryman-add-new-delivery-man" element={<AddNewDeliveryMan />}/>
